...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Thu Oct 26 13:12:19 2017
# Project:  NotePad.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.7.4/bin/qmake -spec /usr/local/Trolltech/Qt-4.7.4/mkspecs/linux-g++ -o Makefile NotePad.pro
#############################################################################
...
SOURCES       = main.cpp \
		MainWindowUI.cpp \
		MainWindowSlots.cpp moc_MainWindow.cpp \
		qrc_Res.cpp
OBJECTS       = main.o \
		MainWindowUI.o \
		MainWindowSlots.o \
...
Makefile: NotePad.pro  /usr/local/Trolltech/Qt-4.7.4/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.7.4/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/modules/qt_webkit_version.pri \
	...
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.7.4/mkspecs/linux-g++ -o Makefile NotePad.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/NotePad1.0.0/ && $(COPY_FILE) --parents MainWindow.h .tmp/NotePad1.0.0/ && $(COPY_FILE) --parents Res.qrc .tmp/NotePad1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindowUI.cpp MainWindowSlots.cpp .tmp/NotePad1.0.0/ && (cd `dirname .tmp/NotePad1.0.0` && $(TAR) NotePad1.0.0.tar NotePad1.0.0 && $(COMPRESS) NotePad1.0.0.tar) && $(MOVE) `dirname .tmp/NotePad1.0.0`/NotePad1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/NotePad1.0.0
...
qrc_Res.cpp: Res.qrc \
		...
		replace.png \
		open.png
	/usr/local/Trolltech/Qt-4.7.4/bin/rcc -name Res Res.qrc -o qrc_Res.cpp
...
MainWindowUI.o: MainWindowUI.cpp MainWindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MainWindowUI.o MainWindowUI.cpp

MainWindowSlots.o: MainWindowSlots.cpp MainWindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MainWindowSlots.o MainWindowSlots.cpp
